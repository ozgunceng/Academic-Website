...
$paralelderssor=$db->prepare("SELECT * FROM paralelders order by paralelders_id ASC");
$paralelderssor->execute();
		...
		<div class="container">
			<div class="row">
				<div class="span12 aligncenter flyUp">
					<h2 class="pagetitle"> <strong>Parallel Programming</strong></h2>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="tabbable">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="one">
								<p>
									<?php echo $derslercek["paralel_details"] ?>
							...
							<div class="tab-pane" id="two">
								<p>
																		<?php echo $derslercek["paralel_book"] ?>

								</p>
							</div>
							<div class="tab-pane" id="three">
								<p>
																		<?php echo $derslercek["paralel_asses"] ?>
...
$say=0;
  ...
  while($paralelderscek=$paralelderssor->fetch(PDO::FETCH_ASSOC)){ $say++ 
   ...
   ?>	<?php 
                          ...
                          $paralelders_id=$paralelderscek['paralelders_id'];
					$paraleldersfotosor=$db->prepare("SELECT * FROM paraleldersfoto where paralelders_id=:paralelders_id  ");
					$paraleldersfotosor->execute(array(
						'paralelders_id' => $paralelders_id
						));

					$paraleldersfotocek=$paraleldersfotosor->fetch(PDO::FETCH_ASSOC);
...
?>
    ...
    <tr>
      ...
      <td><h4><?php echo $paralelderscek['paralelders_hafta']; ?></h4></td>
      <td><a href="./<?php echo $paraleldersfotocek['paraleldersfoto_dosyayol']; ?>"><p><?php echo $paraleldersfotocek['paralelders_pdf']; ?></p></a></td>
    </tr>
   <?php }  ?>
