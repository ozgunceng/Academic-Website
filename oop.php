...
$oopderssor=$db->prepare("SELECT * FROM oopders order by oopders_id ASC");
$oopderssor->execute();
		...
		<div class="container">
			<div class="row">
				<div class="span12 aligncenter flyUp">
					<h2 class="pagetitle"> <strong>Object Oriented Programming</strong></h2>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="tabbable">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="one">
								<p>
									<?php echo $derslercek["oop_details"] ?>
							...
							<div class="tab-pane" id="two">
								<p>
																		<?php echo $derslercek["oop_book"] ?>

								</p>
							</div>
							<div class="tab-pane" id="three">
								<p>
																		<?php echo $derslercek["oop_asses"] ?>
...
$say=0;
  ...
  while($oopderscek=$oopderssor->fetch(PDO::FETCH_ASSOC)){ $say++ 
   ...
   ?>	<?php 
                          ...
                          $oopders_id=$oopderscek['oopders_id'];
					$oopdersfotosor=$db->prepare("SELECT * FROM oopdersfoto where oopders_id=:oopders_id  ");
					$oopdersfotosor->execute(array(
						'oopders_id' => $oopders_id
						));

					$oopdersfotocek=$oopdersfotosor->fetch(PDO::FETCH_ASSOC);
...
?>
    ...
    <tr>
      ...
      <td><h4><?php echo $oopderscek['oopders_hafta']; ?></h4></td>
      <td><a href="./<?php echo $oopdersfotocek['oopdersfoto_dosyayol']; ?>"><p><?php echo $oopdersfotocek['oopders_pdf']; ?></p></a></td>
    </tr>
   <?php }  ?>
